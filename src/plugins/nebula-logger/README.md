...
> :warning: **Note:** If you are copying the Apex classes manually (managed package scenario), you will also need to manually create these two `DatabaseLayerParameter__mdt` records:
>
> | DeveloperName             | Value                              |
> | ------------------------- | ---------------------------------- |
